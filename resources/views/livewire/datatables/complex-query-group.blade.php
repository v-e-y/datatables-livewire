            ...
            @elseif($rule['type'] === 'group')
                ...
                >
                    <span class="d-flex justify-content-center space-x-4">
                        <button wire:click="addRule('{{ collect(explode('.', $key))->join(".content.") . ".content" }}')" class="d-flex align-items-center px-3 py-2 border border-blue-400 text-blue-500 text-xs font-medium text-uppercase  ">ADD RULE</button>
                        <button wire:click="addGroup('{{ collect(explode('.', $key))->join(".content.") . ".content" }}')" class="d-flex align-items-center px-3 py-2 border border-blue-400 text-blue-500 text-xs font-medium text-uppercase  ">ADD GROUP</button>
                    </span>
