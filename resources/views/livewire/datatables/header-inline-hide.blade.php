<div wire:click.prefetch="toggle('{{ $index }}')"
     ...
     <button class="position-relative h-12 w-3">
         <span
             class="w-32 hidden group-hover:inline-block position-absolute z-10 top-0 left-0 ml-3 bg-blue-300 font-medium text-xs text-start text-blue-700  transform uppercase">
