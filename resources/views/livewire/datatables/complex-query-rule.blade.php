            ...
            <div class="sm:w-1/3">
                ...
                <div class="position-relative">
                    <select wire:model="rules.{{ $key }}.column" name="selectedColumn"
                        class="w-100 my-1 text-sm text-gray-900 block rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        <option value=""></option>
                        ...
                        <div class="position-relative">
                            ...
                            @elseif($column['type'] === 'date')
                                <input type="date" name="value" wire:model.lazy="rules.{{ $key }}.value"
                                    class="w-100 px-3 py-2 border my-1 text-sm text-gray-900 block rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
