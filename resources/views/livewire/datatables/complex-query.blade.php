...
>
    <div class="my-4 d-flex justify-content-between text-xl text-uppercase font-medium">
    ...
    @if(count($savedQueries ?? []))
        <div>
            <div class="mt-8 my-4 text-xl text-uppercase font-medium">Saved Queries</div>
