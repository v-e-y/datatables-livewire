                ...
                <div class="mt-2 sm:mt-0  sm:">
                    @isset($savedQueries)
                        <div class="d-flex align-items-center " x-data="{
                            ...
                            <button x-bind:disabled="! name" x-show="rules" x-on:click="saveQuery" class="d-flex align-items-center  px-3 py-0.5 border border-green-400 disabled:border-gray-300 text-green-500 disabled:text-gray-300  text-uppercase  hover:bg-green-200 disabled:hover:bg-white disabled:pointer-events-none">
                                <span>{{ __('Save') }}</span>
