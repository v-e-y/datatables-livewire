<div x-data="{ show: false }" class="d-flex flex-col align-items-center">
    <div class="d-flex flex-col align-items-center position-relative">
        <button x-on:click="show = !show" class="px-3 py-2 border border-blue-400 rounded-md bg-white text-blue-500 text-xs font-medium text-uppercase  hover:bg-blue-200">
