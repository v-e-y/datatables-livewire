<div x-data="{ show: false }" class="d-flex flex-col align-items-center">
    <div class="d-flex flex-col align-items-center position-relative">
        ...
        <div x-show="show" x-on:click.away="show = false" class="z-50 position-absolute mt-16 -mr-4 shadow-2xl top-100  w-96 right-0 rounded max-h-select overflow-y-auto" x-cloak>
