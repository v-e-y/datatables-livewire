<div x-data class="flex flex-col">
    ...
    <div class="flex flex-wrap max-w-48 space-x-1">
        ...
        <button wire:click="removeTextFilter('{{ $index }}', '{{ $key }}')" class="m-1 pl-1 d-flex items-items-center uppercase tracking-wide bg-gray-300 text-white hover:bg-red-600 rounded-full focus:outline-none text-xs space-x-1">
