<div x-data class="d-flex flex-col">
    <div class="w-100 position-relative d-flex">
        <input x-ref="start" class="w-100 pr-8 m-1  block border-gray-300 shadow-sm " type="datetime-local"
    ...
    <div class="w-100 position-relative d-flex align-items-center">
        <input x-ref="end" class="w-100 pr-8 m-1  block border-gray-300 shadow-sm " type="datetime-local"
