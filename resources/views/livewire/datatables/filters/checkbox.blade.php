@if ($isOnToggleSelectAll)
    <div
        @if (isset($column['tooltip']['text'])) title="{{ $column['tooltip']['text'] }}" @endif
        class="d-flex flex-column align-items-center h-100 p-3 overflow-hidden text-start text-gray-500 text-uppercase align-top bg-light bg-gradient border-bottom border-gray-200 space-y-2">
