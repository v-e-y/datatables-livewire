<div
    ...
    class="d-flex flex-col align-items-center h-100 px-6 py-5 overflow-hidden text-xs font-medium  text-start text-gray-500 text-uppercase align-top bg-blue-100 border-b border-gray-200 space-y-2">
