<div
    ...
    class="d-flex flex-col align-items-center h-full px-6 py-5 overflow-hidden text-xs font-medium  text-left text-gray-500 uppercase align-top bg-blue-100 border-b border-gray-200 space-y-2">
